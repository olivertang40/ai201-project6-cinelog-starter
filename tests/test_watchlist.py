...
def test_get_watchlist_returns_alphabetical(app, sample_user):
    """
    get_watchlist() should return films sorted by title ascending (A → Z).
    """
    with app.app_context():
        ...
        entry_a = WatchlistEntry(user_id=sample_user, film_id=film_a.id)
        entry_b = WatchlistEntry(user_id=sample_user, film_id=film_b.id)
        ...
        # Alien comes before Blade Runner alphabetically
